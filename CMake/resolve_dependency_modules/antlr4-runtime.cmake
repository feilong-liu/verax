...
# Set CMake options for ANTLR4
set(ANTLR4_INSTALL ON CACHE BOOL "Enable installation for antlr4-runtime")
set(ANTLR_BUILD_CPP_TESTS OFF CACHE BOOL "Disable tests for antlr4-runtime")

FetchContent_MakeAvailable(antlr4-runtime)

message(STATUS "DONE Building antlr4-runtime from source")

# Ensure the build directory is in the CMAKE_PREFIX_PATH for find_package
message(STATUS ${antlr4-runtime_BINARY_DIR})
list(APPEND CMAKE_PREFIX_PATH ${antlr4-runtime_BINARY_DIR})
message(STATUS ${CMAKE_PREFIX_PATH})

set(ANTLR4_INCLUDE_DIR  ${antlr4-runtime_BINARY_DIR})

message(STATUS "DONE Setting antlr4-runtime paths")
